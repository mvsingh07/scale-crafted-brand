...
const PLATFORM_DEMOS: EcosystemProject[] = [];
...
export default function WorkPage() {
  ...
  useEffect(() => {
    supabase
      ...
      .then(({ data }) => {
        setProjects((data as EcosystemProject[]) ?? PLATFORM_DEMOS);
        setLoading(false);
      });
  }, []);
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "64px 32px 80px" }}>
        ...
        >
          ...
          <p style={{
            ...
            color: SILVER, marginTop: 16, maxWidth: 560, lineHeight: 1.7, margin: "16px 0 0",
          }}>
            Projects I&apos;m actively working on — open to the right collaborators, whether that&apos;s technical help, investment, or amplification.
          </p>
...
function ProjectCard({ project: p, index }: { project: EcosystemProject; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div
        style={{ padding: "28px 32px 24px", cursor: "pointer" }}
      ...
      >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10, flexWrap: "wrap" }}>
              <span style={{
                ...
                padding: "3px 10px", fontFamily: "var(--font-inter), Inter, sans-serif",
                fontSize: 10, letterSpacing: "0.1em", color: status.color,
              }}>
                {status.label}
              </span>
            ...
            <h2 style={{
              ...
              fontWeight: 600, color: WHITE, margin: "0 0 8px",
            }}>
              {p.title}
            </h2>
            <p style={{
              fontFamily: "var(--font-inter), Inter, sans-serif",
              fontSize: 14, color: SILVER, margin: 0, lineHeight: 1.6,
            }}>
              {p.tagline}
            </p>
          </div>
        ...
        {p.description && (
          <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 16 }}>
            ...
            <motion.span animate={{ rotate: expanded ? 180 : 0 }} transition={{ duration: 0.25 }} style={{ lineHeight: 1, color: "var(--text-muted)", fontSize: 12 }}>
              ↓
            </motion.span>
          </div>
        )}
      ...
      <AnimatePresence>
        {expanded && p.description && (
          ...
          >
            <div style={{
              padding: "0 32px 28px",
              borderTop: "1px solid color-mix(in srgb, var(--gold-border) 15%, transparent)",
              paddingTop: 20,
            }}>
              <p style={{
                fontFamily: "var(--font-inter), Inter, sans-serif",
                fontSize: 14, lineHeight: 1.8, color: SILVER, margin: "0 0 20px",
                maxWidth: 700,
              }}>
                {p.description}
              </p>
