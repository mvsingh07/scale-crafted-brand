...
export function ContactSection() {
  ...
  type ContactLink = { icon: React.ElementType; label: string; href: string };
  const links: ContactLink[] = [
    ...
    ...(twitter  ? [{ icon: Twitter,  label: twitter.replace(/^https?:\/\//, ""),  href: twitter  }] : []),
  ];
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "64px 32px 80px" }}>
      ...
      >
        ...
        <p style={{ fontFamily: "var(--font-inter), Inter, sans-serif", fontSize: "clamp(14px, 1.6vw, 17px)", color: SILVER, marginTop: 16, maxWidth: 540, lineHeight: 1.7 }}>
      ...
      <div style={{ display: "grid", gap: 48 }} className="lg:grid-cols-2">
        ...
        >
          {links.length === 0 ? (
            <p style={{ fontFamily: "var(--font-inter), Inter, sans-serif", fontSize: 13, color: MUTED }}>
            ...
            >
              ...
              <ArrowRight size={15} style={{ color: "var(--gold-border)" }} />
            </motion.a>
          ))}
        </motion.div>
        ...
        >
          <div style={{ display: "grid", gap: 16 }} className="sm:grid-cols-2">
            ...
            <div><label style={labelStyle}>Email</label><input name="email" required type="email" placeholder="you@company.com" style={inputStyle} /></div>
          </div>
          <div>
          ...
          <div>
            ...
            <textarea name="message" required rows={5} placeholder="Tell me about what you're building…" style={{ ...inputStyle, resize: "vertical" }} />
          </div>
          <motion.button
            ...
            style={{
              ...
              fontFamily: "var(--font-inter), Inter, sans-serif", fontSize: 14, fontWeight: 600,
